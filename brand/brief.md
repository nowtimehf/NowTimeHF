...
> This file is the source of truth for voice, audience, and content strategy.
> Every content command (`/post-writer`, `/post-grader`, `/content-coach`,
> `/repurpose`, `/viral-hooks`, `/generate-visuals`) reads this file before
> doing its work. Keep it current — run `/brand-brief` any time something
> below changes.
...
- **Their top pain points:**
  ...
  - Average corporate wellness programs see only 6–8% employee participation — paying for access nobody uses, then watching premiums climb anyway.
- **Their goals / what they want to become:** Reduce turnover, absenteeism, and insurance costs; be able to prove ROI on wellness spend to leadership; partner with someone who actually drives usage instead of selling access nobody touches.
...
2. **The Engagement Gap** — why the industry-average 6–8% participation rate fails, and what real engagement looks like.
3. **Program Design** — how the live workshops + white-labeled digital platform actually work.
4. **Client Results** — case studies, data, testimonials proving engagement and outcomes.
...
- **Never:** Call the offer a "perk" or "gym reimbursement." Use vague wellness buzzwords without a concrete data point or action attached.
